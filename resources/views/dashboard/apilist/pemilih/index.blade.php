...
<div class="bg-white mt-4 flex flex-col max-w-5xl mx-auto h-96 overflow-x shadow-sm">
...
<div class="bg-white max-w-5xl mx-auto overflow-x shadow-sm border-t-2 border-indigo-600 p-4">
    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-indigo-600">Statistik Calon Pemilih Desa {{ $desa->nama }}</h5>
    {!! $chart->container() !!}
