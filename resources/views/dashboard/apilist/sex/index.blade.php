...
<div class="rounded-md mt-5 mx-auto max-w-5xl">
    <ol class="list-reset flex">
        ...
        <li><span class="text-gray-500 mx-2">/</span></li>
        <li class="text-gray-500">Data Jenis Kelamin</li>
    </ol>
</div>
...
<div class="bg-white max-w-5xl mx-auto overflow-x shadow-sm border-t-2 border-indigo-600 p-4">
    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-indigo-600">Statistik Jenis Kelamin Desa {{ $desa->nama }}</h5>
    {!! $chart->container() !!}
