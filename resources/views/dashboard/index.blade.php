    ...
    <div class="row">
        <div class="col-xl-6 col-md-6">
            ...
            <div class="card bg-primary text-white mb-4">
                <div class="card-body">
                    <div>Kecamatan {{ $kecamatan->id }}</div>
                    <h3 class="text-white">{{ $kecamatan->nama }}</h3>
                </div>
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-white stretched-link" href="/dashboard/kecamatans/{{ $kecamatan->id }}">View Details</a>
